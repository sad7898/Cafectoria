...
const IntroText = () => {
  ...
  const fetchPie = useCallback(async () => {
    await Axios.get("https://cafetoria-backend.herokuapp.com/api/pie").then(
      (res) => {
      ...
      <Row>
        <Col xs={12} md={4} className="mb-4">
          <IntroContent imgSrc={Icon}>
            ...
            <SubHeader sizeDesktop="1rem">
              Delicious food makes you brighter.
            </SubHeader>
          </IntroContent>
        </Col>
        <Col xs={12} md={4} className="mb-4">
          <IntroContent imgSrc={Watch}>
            ...
            <SubHeader sizeDesktop="1rem">
              Say goodbye to standing in queue.
            </SubHeader>
          </IntroContent>
        </Col>
        <Col xs={12} md={4} className="mb-4">
